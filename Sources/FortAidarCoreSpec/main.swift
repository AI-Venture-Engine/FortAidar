...
func specHdiutilCommandPolicy() {
    ...
    expect(!attach.arguments.contains("-noexec"), "attach avoids unsupported noexec flag")
    expect(!attach.arguments.contains("-nosuid"), "attach avoids unsupported nosuid flag")
    expect(!attach.arguments.contains("-nodev"), "attach avoids unsupported nodev flag")
    expect(!attach.arguments.contains("-quiet"), "attach preserves hdiutil errors for the app")
